...
(defun check-system-autoloads (system &key (errorp t))
  ...
  - If there is a [:RECORD-AUTOLOADS][ system-record-autoloads], then
    the file generated by RECORD-SYSTEM-AUTOLOADS is up-to-date. This
    compares the current AUTOLOADS to those in the file with EQUAL and
    is thus sensitive to the order of definitions.
